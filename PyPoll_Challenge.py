...
# file path : Resoruces/election_results.csv
file_to_load = os.path.join("Resources", "election_results.csv")
...
# Initialize a list to hold counties
county_list = []
# Initialize a dictionary with county as key 
# and votes cast in each county as value
county_votes = {}
...
# Initialize county with largest turnout
winning_county = ""
# Initialize the number of votes of winning county
